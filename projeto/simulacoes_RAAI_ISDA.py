...
for x in todos_X:
    ...
    s1 = simulacao(X0,       y, num_simulacoes) # Preenchimento com 0
    s2 = simulacao(Xmedia,   y, num_simulacoes) # Preenchimento com a média
    s3 = simulacao(Xmediana, y, num_simulacoes) # Preenchimento com a mediana
    s4 = simulacao(Xnn,      y, num_simulacoes) # Preenchimento com os vizinhos mais próximos
    s5 = simulacao(Xmice,    y, num_simulacoes) # Preenchimento com MICE
    lista_acuracia.append([s1, s2, s3, s4, s5])

...
def read_data_cenario(cenario):
    ...
    filename='C:/Users/jpsco/Documents/Professor/Doutorado/PGMC/BD2020/DRC/CIIS2020/data/'+cenario
    ...
    df_true  = [True  for i in range(int(df.shape[0]*0.7))]
    df_false = [False for i in range(int(df.shape[0]*0.3))]
...
#     #%%
#     #filename='./data/Banco35exames.csv'
#     filename='C:/Users/jpsco/Documents/Professor/Doutorado/PGMC/BD2020/DRC/CIIS2020/data/Banco35exames_SoExames.csv'
